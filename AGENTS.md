...
- `api/cmd/api/main.go` — 9 bug fixes, last fix 13 days ago (bug magnet); 45 commits/90d
- `frontend/src/components/light/PhotoLibraryPickerDialog.js` — 5 bug fixes, last fix 2 weeks ago (bug magnet); 13 commits/90d
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 3 weeks ago (bug magnet); 22 commits/90d
- `frontend/src/pages/public/PostPage.js` — 6 bug fixes, last fix 3 weeks ago (bug magnet); 17 commits/90d

### Code health
Three co-equal signals: code health 6.08/10 avg (Fair), hotspot health 4.4/10 (improving), worst `api/internal/services/post_publish.go` at 1.0/10 · maintainability 7.02/10 · performance risk 152 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
