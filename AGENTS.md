...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-11 (commit 24c316e). Confidence: 99%.
...
- `frontend/src/pages/light/PostEditPage.js` — 11 bug fixes, last fix 9 days ago (bug magnet); 35 commits/90d
...
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 2 weeks ago (bug magnet); 28 commits/90d
