...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-09 (commit 7fcd89c). Confidence: 99%.
...
- `api/cmd/api/main.go` — 9 bug fixes, last fix 6 days ago (bug magnet); 59 commits/90d
- `frontend/src/components/light/PhotoLibraryPickerDialog.js` — 5 bug fixes, last fix 6 days ago (bug magnet); 12 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.19/10 avg, hotspot health 4.07/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.1/10 · performance risk 149 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
