...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-09 (commit 0d15d5b). Confidence: 99%.
...
- `api/cmd/api/main.go` — 9 bug fixes, last fix 5 days ago (bug magnet); 60 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.2/10 avg, hotspot health 4.03/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.11/10 · performance risk 149 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
