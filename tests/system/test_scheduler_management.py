"""Tests for system scheduler features."""
...
class TestSchedulerService:
    ...
    @pytest.mark.asyncio
    async def test_tasks_execution(self) -> None:
        """Test manual execution of scheduled tasks."""
    ...
    @pytest.mark.asyncio
    async def test_scheduler_service_coverage(self) -> None:
        """Additional coverage for scheduler service functions."""
    ...
    @pytest.mark.asyncio
    async def test_scheduler_cleanup_sessions(self) -> None:
        """Test cleanup_sessions task specifically."""
        with patch("app.services.scheduler_service.AsyncIOScheduler"):
            scheduler = SchedulerService()
    ...
    @pytest.mark.asyncio
    async def test_scheduler_create_backup(self) -> None:
        """Test daily_backup task specifically."""
        with patch("app.services.scheduler_service.AsyncIOScheduler"):
            scheduler = SchedulerService()
...
@pytest.mark.asyncio
async def test_database_session_context_manager(db: AsyncSession) -> None:
    """Test database session works as context manager (moved from scheduler tests)."""
