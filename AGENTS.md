...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-11 (commit 11cfefa). Confidence: 99%.
...
- `frontend/src/pages/light/PostEditPage.js` — 11 bug fixes, last fix 8 days ago (bug magnet); 34 commits/90d
- `api/cmd/api/main.go` — 9 bug fixes, last fix 8 days ago (bug magnet); 56 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.27/10 avg, hotspot health 4.01/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.13/10 · performance risk 145 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
