...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-08 (commit 50f4a47). Confidence: 99%.
...
- `frontend/src/pages/light/PostEditPage.js` — 11 bug fixes, last fix 6 days ago (bug magnet); 35 commits/90d
...
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 11 days ago (bug magnet); 32 commits/90d
- `frontend/src/pages/public/PostPage.js` — 6 bug fixes, last fix 2 weeks ago (bug magnet); 21 commits/90d

### Code health
Three co-equal signals: defect risk 6.14/10 avg, hotspot health 3.99/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.07/10 · performance risk 149 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
This project is indexed by GitNexus as **point** (14666 symbols, 56943 relationships, 907 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/point/context` | Codebase overview, check index freshness |
| `gitnexus://repo/point/clusters` | All functional areas |
| `gitnexus://repo/point/processes` | All execution flows |
| `gitnexus://repo/point/process/{name}` | Step-by-step execution trace |
