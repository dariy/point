...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit fd986a1). Confidence: 99%.
...
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 12 days ago (bug magnet); 30 commits/90d
- `frontend/src/pages/public/PostPage.js` — 6 bug fixes, last fix 2 weeks ago (bug magnet); 21 commits/90d

### Code health
Three co-equal signals: defect risk 6.16/10 avg, hotspot health 4.13/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.11/10 · performance risk 150 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
