...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-11 (commit d5bafc2). Confidence: 99%.
...
### Code health
Three co-equal signals: defect risk 6.28/10 avg, hotspot health 4.09/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.13/10 · performance risk 135 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
