...
const PLUGIN_SETTINGS = {
  ...
  "simple-post-list": { keys: ["enable_video_hover_autoplay", "thumbnail_width", "thumbnail_height"], sections: ["rebuild-thumbnails"] },
  "dynamic-post-list": { keys: ["enable_video_hover_autoplay", "thumbnail_width", "thumbnail_height"], sections: ["rebuild-thumbnails"] },
