...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 94f02d8). Confidence: 99%.
...
- `api/cmd/api/main.go` — 9 bug fixes, last fix 6 days ago (bug magnet); 56 commits/90d
- `frontend/src/components/light/PhotoLibraryPickerDialog.js` — 5 bug fixes, last fix 7 days ago (bug magnet); 12 commits/90d
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 12 days ago (bug magnet); 32 commits/90d
- `frontend/src/pages/public/PostPage.js` — 6 bug fixes, last fix 2 weeks ago (bug magnet); 21 commits/90d

### Code health
Three co-equal signals: defect risk 6.18/10 avg, hotspot health 4.11/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.1/10 · performance risk 149 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
