...
class TestTagList:
    ...
    @pytest.mark.asyncio
    async def test_list_tags_filtered(self, client: AsyncClient, db: AsyncSession):
...
class TestTagGet:
    ...
    @pytest.mark.asyncio
    async def test_get_tag_by_slug_not_found(self, client: AsyncClient):
...
class TestTagUpdate:
    ...
    @pytest.mark.asyncio
    async def test_update_tag_not_found(self, client: AsyncClient, auth_cookies: dict):
...
class TestTagPosts:
    ...
    @pytest.mark.asyncio
    async def test_get_posts_by_tag_slug_not_found(self, client: AsyncClient):
