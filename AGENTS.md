...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-09 (commit aa43bac). Confidence: 99%.
...
- `api/cmd/api/main.go` — 9 bug fixes, last fix 5 days ago (bug magnet); 59 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.2/10 avg, hotspot health 4.07/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.11/10 · performance risk 149 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `frontend/src/pages/public/SearchPage.js` — untested hotspot — impact −2.0
