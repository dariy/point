...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-09-10 (commit 9b293c6). Confidence: 99%.
...
- `frontend/src/pages/light/PostEditPage.js` — 11 bug fixes, last fix 7 days ago (bug magnet); 34 commits/90d
- `api/cmd/api/main.go` — 9 bug fixes, last fix 7 days ago (bug magnet); 56 commits/90d
- `frontend/src/components/light/PhotoLibraryPickerDialog.js` — 5 bug fixes, last fix 7 days ago (bug magnet); 12 commits/90d
- `frontend/src/pages/public/TagPage.js` — 6 bug fixes, last fix 13 days ago (bug magnet); 30 commits/90d
- `frontend/src/pages/public/PostPage.js` — 6 bug fixes, last fix 2 weeks ago (bug magnet); 19 commits/90d

### Code health
Three co-equal signals: defect risk 6.22/10 avg, hotspot health 4.0/10 (stable), worst `frontend/src/pages/public/HomePage.js` at 1.0/10 · maintainability 8.13/10 · performance risk 150 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
